...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { AuthenticationClient, AuthenticationClientOptions } from './core';
...
<span class="branch-0 cbranch-no" title="branch not covered" >  new StorageWrapper(window.localStorage) </span>: new MemoryStorage();
&nbsp;
