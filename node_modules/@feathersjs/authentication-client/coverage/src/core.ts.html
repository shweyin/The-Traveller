...
<html lang="en">
<head>
    <title>Code coverage report for src/core.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> core.ts
    </h1>
    <div class='clearfix'>
...
<a name='L178'></a><a href='#L178'>178</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { NotAuthenticated } from '@feathersjs/errors';
...
<span class="cstat-no" title="statement not covered" >        this.reAuthenticate(true);</span>
      }
    });
  }
&nbsp;
  ...
  getAccessToken (): Promise&lt;string|null&gt; {
    return this.storage.getItem(this.options.storageKey)
      .then((accessToken: string) =&gt; {
        if (!accessToken &amp;&amp; typeof window !== 'undefined' &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >window.location)</span> {
<span class="cstat-no" title="statement not covered" >          return this.getFromLocation(window.location);</span>
        }
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Apr 23 2019 19:03:46 GMT-0700 (Pacific Daylight Time)
</div>
</div>
